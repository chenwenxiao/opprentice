<template>
  <div>
    <div class="menu-wrap">
      <nav class="menu">
        <div class="icon-list">
          <a href="#" @click="option.label=!option.label"><i class="fa fa-fw" :class="{'fa-star': option.label, 'fa-star-o': !option.label}"></i><span>Label</span></a>
          <a href="#" @click="option.scale=!option.scale"><i class="fa fa-fw" :class="{'fa-bell': option.scale, 'fa-bell-o': !option.scale}"></i><span>Scale</span></a>
          <a href="#" @click="option.message=!option.message"><i class="fa fa-fw" :class="{'fa-envelope': option.message, 'fa-envelope-o': !option.message}"></i><span>Message</span></a>
